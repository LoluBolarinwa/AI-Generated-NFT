...
function App() {
  ...
  return (
    <div>
      ...
      <div className="form">
        <div className="image">
          <img src={`https://i.postimg.cc/3rprDXrx/centaur-holding-a-bow-and-arrow-inspired-by-Yanjun-Cheng-style-digital-art-trending-on-dezeen-ca.jpg`} alt="AI generated Image" />
        </div>
